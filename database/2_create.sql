...
ALTER TABLE county ADD CONSTRAINT county_country
...
ALTER TABLE event_game ADD CONSTRAINT event_game_event
...
ALTER TABLE event_game ADD CONSTRAINT event_game_game
    FOREIGN KEY (game_id)
        REFERENCES game (id)
        NOT DEFERRABLE
            INITIALLY IMMEDIATE
...
ALTER TABLE event ADD CONSTRAINT event_skill
...
ALTER TABLE feedback ADD CONSTRAINT feedback_type
    FOREIGN KEY (type_id)
        REFERENCES type (id)
        NOT DEFERRABLE
            INITIALLY IMMEDIATE
...
ALTER TABLE game_tag ADD CONSTRAINT game_tag_game
    FOREIGN KEY (game_id)
        REFERENCES game (id)
        NOT DEFERRABLE
            INITIALLY IMMEDIATE
...
ALTER TABLE game_tag ADD CONSTRAINT game_tag_tag
    FOREIGN KEY (tag_id)
        REFERENCES tag (id)
        NOT DEFERRABLE
            INITIALLY IMMEDIATE
...
ALTER TABLE profile ADD CONSTRAINT profile_city
    FOREIGN KEY (city_id)
        REFERENCES city (id)
        NOT DEFERRABLE
            INITIALLY IMMEDIATE
...
ALTER TABLE profile ADD CONSTRAINT profile_gender
